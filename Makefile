...
CXX = g++
CXXFLAGS = -Wall -Wextra -pedantic -Wno-sign-compare -Wno-strict-aliasing -Wno-unused-function -Wno-unused-parameter -Wno-unused-variable -O3 $(INCLUDES) $(DEBUG) --std=c++11
